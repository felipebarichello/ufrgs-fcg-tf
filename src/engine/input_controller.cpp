...
std::vector<DPadState> InputController::vector_state;
...
void InputController::subscribe_dpad(glm::vec2* direction, int forward_key, int backward_key, int left_key, int right_key) {
    ...
    vector_state.push_back(DPadState());
    DPadState& state = vector_state.back();
...
void InputController::update_key_move_vector(DPadState& vector_state) {
