...
void LoadShadersFromFiles()
{
    ...
    //
    GLuint vertex_shader_id = LoadShader_Vertex("../../src/engine/shaders/shader_vertex.glsl");
    GLuint fragment_shader_id = LoadShader_Fragment("../../src/engine/shaders/shader_fragment.glsl");
